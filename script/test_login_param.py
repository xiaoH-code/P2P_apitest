...
class test_login_param(unittest.TestCase):
    phone = '13088881111'
    ...
    @parameterized.expand(read_verify_data("verify.json","test_get_img_verify_code","random_type,status_code"))
    def test1_get_img_verify_code(self,random_type,status_code):
        """测试图片验证码的请求的随机字符为小数、整数和字母"""
        #构建测试数据
        r = ''
        print("init")
